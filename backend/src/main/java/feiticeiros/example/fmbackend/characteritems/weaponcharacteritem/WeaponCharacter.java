package feiticeiros.example.fmbackend.characteritems.weaponcharacteritem;

import feiticeiros.example.fmbackend.DamageType;
import feiticeiros.example.fmbackend.characteritems.characteritem.CharacterItemEntity;
import feiticeiros.example.fmbackend.characteritems.weaponcharacteritem.weaponmodifiers.WeaponModifiersEntity;
