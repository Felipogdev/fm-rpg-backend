...
public class ClassAbilityFighterSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        List<ClassAbility> classAbilities = new ArrayList<>(List.of(
                ...
                new ClassAbility("Defesa Marcial", "Você é capaz de incorporar a leveza de seus movimentos em sua defesa. Enquanto estiver desarmado ou empunhando uma arma marcial, você soma 1 + metade do seu Bônus de Treinamento à sua Defesa.", 4, fighter, classAbilityRepository.findByName("Complementação Marcial")),
                new ClassAbility("Devolver Projéteis", "Sua capacidade de aparar é aprimorada, abrindo também oportunidades para os devolver. O dado de Aparar Projéteis se torna 3d10 e soma também o seu Nível de Lutador. Caso você use Aparar Projéteis e o dano se torne nulo ou negativo, você pode devolver o projétil como parte da reação.", 4, fighter, classAbilityRepository.findByName("Aparar Projéteis")),
                ...
                new ClassAbility("Sobrevivente", "Como um lutador, você deve sobreviver, recuperando-se quando sente a vitalidade esvaindo. Enquanto estiver com menos da metade dos seus pontos de vida máximos, sempre que começar seu turno, você recupera 1d6 + seu modificador de Constituição em pontos de vida.", 4, fighter),
                ...
                new ClassAbility("Punhos Letais", "Não há necessidade de armas se o seu corpo já é a mais letal entre elas. Enquanto estiver desarmado, sua margem de crítico diminui em 1 e seus ataques ignoram RD igual ao seu bônus de treinamento.", 8, fighter, classAbilityRepository.findByName("Poder Corporal")),

                // Level 10 abilities
                new ClassAbility("Alma Quieta", "Sua alma é imperturbável durante uma boa luta. Você recebe vantagem para resistir às seguintes condições: Condenado, Enfeitiçado e Fragilizado.", 10, fighter),
                new ClassAbility("Corpo Sincronizado", "Seu corpo está sempre em sincronia. Você recebe vantagem para resistir às seguintes condições: Caído e Exposto.", 10, fighter),
                ...
                new ClassAbility("Duro na Queda", "Quando estiver nas portas da morte, você pode escolher receber uma falha garantida para fazer um teste de Vontade contra a CD X, sendo X igual a 15 + 1 para cada 3 pontos de vida negativos. Se passar, você levanta com 1 de vida e recebe 1 ponto de exaustão.", 16, fighter)
        ));
